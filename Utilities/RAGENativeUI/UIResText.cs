...
namespace NativeUI
{
    ...
    public class UIResText : UIText
    {
        ...
        public override void Draw(Size offset)
        {
            ...
            Rage.Native.NativeFunction.CallByName<uint>("SET_TEXT_FONT", (int)Font);
            ...
            Rage.Native.NativeFunction.CallByName<uint>("SET_TEXT_COLOUR", Color.R, Color.G, Color.B, Color.A);
